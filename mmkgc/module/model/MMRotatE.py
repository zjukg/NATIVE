...
class MMRotatE(Model):
    ...
    def __init__(self, ent_tot, rel_tot, dim=100, margin=6.0, epsilon=2.0, img_emb=None, img_dim=4096, test_mode='lp', beta=0.5):
    ...
    def forward(self, data):
        ...
        # score = self._calc(h_img_emb, t, r, mode) + self._calc(h, t_img_emb, r, mode)
